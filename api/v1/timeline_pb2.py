...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _EPISODE.fields_by_name['type']._options = None
  _EPISODE.fields_by_name['type']._serialized_options = b'\030\001'
  _EPISODE.fields_by_name['name']._options = None
  _EPISODE.fields_by_name['name']._serialized_options = b'\030\001'
  _EPISODE.fields_by_name['name_cn']._options = None
  _EPISODE.fields_by_name['name_cn']._serialized_options = b'\030\001'
  _EPISODE.fields_by_name['sort']._options = None
  _EPISODE.fields_by_name['sort']._serialized_options = b'\030\001'
