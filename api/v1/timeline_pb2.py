...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _SUBJECT.fields_by_name['type']._serialized_options = b'\030\001'
  _SUBJECT.fields_by_name['name']._options = None
  _SUBJECT.fields_by_name['name']._serialized_options = b'\030\001'
  _SUBJECT.fields_by_name['name_cn']._options = None
  _SUBJECT.fields_by_name['name_cn']._serialized_options = b'\030\001'
  _SUBJECT.fields_by_name['image']._options = None
  _SUBJECT.fields_by_name['image']._serialized_options = b'\030\001'
  _SUBJECT.fields_by_name['series']._options = None
  _SUBJECT.fields_by_name['series']._serialized_options = b'\030\001'
  ...
  _globals['_EPISODE']._serialized_end=451
  _globals['_SUBJECTCOLLECTREQUEST']._serialized_start=454
  _globals['_SUBJECTCOLLECTREQUEST']._serialized_end=602
  _globals['_EPISODECOLLECTREQUEST']._serialized_start=604
  _globals['_EPISODECOLLECTREQUEST']._serialized_end=709
  _globals['_SUBJECTPROGRESSREQUEST']._serialized_start=711
  _globals['_SUBJECTPROGRESSREQUEST']._serialized_end=827
  _globals['_TIMELINESERVICE']._serialized_start=830
  _globals['_TIMELINESERVICE']._serialized_end=1155
